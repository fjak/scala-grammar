...
public class ScalaParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Scala");
  ...
  { 
    ScalaParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ScalaParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ScalaParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ScalaParseControllerGenerated.class);
    }
  ...
  { 
    return ScalaParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
